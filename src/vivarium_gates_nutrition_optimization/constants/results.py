...
YLDS_COLUMN_TEMPLATE = "MEASURE_ylds_due_to_{CAUSE_OF_DISABILITY}_AGE_GROUP_{AGE_GROUP}_PREGNANCY_{PREGNANCY_STATE}"
PREGNANCY_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{PREGNANCY_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_PREGNANCY_OUTCOME_{PREGNANCY_OUTCOME}"
PREGNANCY_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{PREGNANCY_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_PREGNANCY_OUTCOME_{PREGNANCY_OUTCOME}"

MATERNAL_DISORDERS_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MATERNAL_DISORDERS_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_ANEMIA_STATUS_AT_BIRTH_{ANEMIA_STATUS_AT_BIRTH}"
MATERNAL_DISORDERS_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MATERNAL_DISORDERS_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_ANEMIA_STATUS_AT_BIRTH_{ANEMIA_STATUS_AT_BIRTH}"

MATERNAL_HEMORRHAGE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MATERNAL_HEMORRHAGE_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_ANEMIA_STATUS_AT_BIRTH_{ANEMIA_STATUS_AT_BIRTH}"
MATERNAL_HEMORRHAGE_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MATERNAL_HEMORRHAGE_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_ANEMIA_STATUS_AT_BIRTH_{ANEMIA_STATUS_AT_BIRTH}"

ANEMIA_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_anemia_{ANEMIA_LEVEL}_person_time_AGE_GROUP_{AGE_GROUP}_PREGNANCY_{PREGNANCY_STATE}"

MATERNAL_BMI_ANEMIA_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_maternal_bmi_anemia_{MATERNAL_BMI_ANEMIA_CATEGORY}_person_time_AGE_GROUP_{AGE_GROUP}_PREGNANCY_{PREGNANCY_STATE}"

INTERVENTION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_intervention_{INTERVENTION}_count_AGE_GROUP_{AGE_GROUP}"
)

PREGNANCY_OUTCOME_COUNT_COLUMN_TEMPLATE = "MEASURE_pregnancy_outcome_{PREGNANCY_OUTCOME}_count_AGE_GROUP_{AGE_GROUP}_INTERVENTION_{INTERVENTION}"
...
CAUSES_OF_DISABILITY = ("maternal_disorders", "anemia", "other_causes","all_causes")
