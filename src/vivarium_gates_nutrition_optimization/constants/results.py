...
PREGNANCY_STATE_PERSON_TIME_COLUMN_TEMPLATE = (
    "MEASURE_{PREGNANCY_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_PREGNANCY_OUTCOME_{PREGNANCY_OUTCOME}"
)
PREGNANCY_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_{PREGNANCY_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_PREGNANCY_OUTCOME_{PREGNANCY_OUTCOME}"
)
