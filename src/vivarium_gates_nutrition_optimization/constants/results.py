...
PREGNANCY_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{PREGNANCY_STATE}_person_time_AGE_GROUP_{AGE_GROUP}"
PREGNANCY_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{PREGNANCY_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}"

MATERNAL_DISORDERS_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MATERNAL_DISORDERS_STATE}_person_time_AGE_GROUP_{AGE_GROUP}"
MATERNAL_DISORDERS_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MATERNAL_DISORDERS_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}"

MATERNAL_HEMORRHAGE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MATERNAL_HEMORRHAGE_STATE}_person_time_AGE_GROUP_{AGE_GROUP}"
MATERNAL_HEMORRHAGE_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MATERNAL_HEMORRHAGE_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}"

ANEMIA_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_anemia_{ANEMIA_LEVEL}_person_time_AGE_GROUP_{AGE_GROUP}"
