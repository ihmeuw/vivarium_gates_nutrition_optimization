...
MATERNAL_BMI_ANEMIA_PERSON_TIME_COLUMN_TEMPLATE = (
    "MEASURE_maternal_bmi_anemia_{MATERNAL_BMI_ANEMIA_CATEGORY}_person_time_AGE_GROUP_{AGE_GROUP}_PREGNANCY_{PREGNANCY_STATE}"
)
