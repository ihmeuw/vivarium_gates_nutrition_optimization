...
PREGNANCY_STATE_PERSON_TIME_COLUMN_TEMPLATE = "pregnancy_{PREGNANCY_STATE}_person_time_age_{AGE_GROUP}"
PREGNANCY_TRANSITION_COUNT_COLUMN_TEMPLATE = "pregnancy_{TRANSITION}_event_count_age_{AGE_GROUP}"
