...
PREGNANCY_TERM_OUTPUT_COUNT_COLUMN_TEMPLATE = "outcome_{TERM_OUTCOME}_count_age_{AGE_GROUP}"
COLUMN_TEMPLATES = {
    ...
    "pregnancy_term_outcome_count": PREGNANCY_TERM_OUTPUT_COUNT_COLUMN_TEMPLATE
}
...
TEMPLATE_FIELD_MAP = {
    ...
    "TERM_OUTCOME": models.PREGNANCY_TERM_OUTCOMES
}
