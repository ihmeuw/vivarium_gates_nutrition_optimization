...
INTERVENTION_COUNT_COLUMN_TEMPLATE = "MEASURE_intervention_{INTERVENTION}_count_AGE_GROUP_{AGE_GROUP}"

PREGNANCY_OUTCOME_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_pregnancy_outcome_{PREGNANCY_OUTCOME}_count_AGE_GROUP_{AGE_GROUP}_INTERVENTION_{INTERVENTION}"
)
