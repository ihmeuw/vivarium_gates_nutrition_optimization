...
PREGNANCY_STATE_PERSON_TIME_COLUMN_TEMPLATE = (
    "{PREGNANCY_STATE}_person_time_age_{AGE_GROUP}_pregnancy_outcome_{PREGNANCY_OUTCOME}"
)
PREGNANCY_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "{PREGNANCY_TRANSITION}_event_count_age_{AGE_GROUP}_pregnancy_outcome_{PREGNANCY_OUTCOME}"
)

MATERNAL_DISORDERS_PERSON_TIME_COLUMN_TEMPLATE = (
    "{MATERNAL_DISORDERS_STATE}_person_time_age_{AGE_GROUP}"
)
MATERNAL_DISORDERS_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "{MATERNAL_DISORDERS_TRANSITION}_event_count_age_{AGE_GROUP}"
)
...
TEMPLATE_FIELD_MAP = {
    ...
    "PREGNANCY_STATE": models.MATERNAL_DISORDERS_MODEL_STATES,
    "PREGNANCY_TRANSITION": models.MATERNAL_DISORDERS_MODEL_TRANSITIONS,
}
