...
MATERNAL_DISORDERS_PERSON_TIME_COLUMN_TEMPLATE = (
    "maternal_disorders_{MATERNAL_DISORDERS_STATE}_person_time_age_{AGE_GROUP}_anemia_status_at_birth_{ANEMIA_STATUS_AT_BIRTH}"
)
MATERNAL_DISORDERS_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "maternal_disorders_{MATERNAL_DISORDERS_TRANSITION}_event_count_age_{AGE_GROUP}_anemia_status_at_birth_{ANEMIA_STATUS_AT_BIRTH}"
)

MATERNAL_HEMORRHAGE_PERSON_TIME_COLUMN_TEMPLATE = (
    "maternal_hemorrhage_{MATERNAL_HEMORRHAGE_STATE}_person_time_age_{AGE_GROUP}_anemia_status_at_birth_{ANEMIA_STATUS_AT_BIRTH}"
)
MATERNAL_HEMORRHAGE_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "maternal_hemorrhage_{MATERNAL_HEMORRHAGE_TRANSITION}_event_count_age_{AGE_GROUP}_anemia_status_at_birth_{ANEMIA_STATUS_AT_BIRTH}"
)
