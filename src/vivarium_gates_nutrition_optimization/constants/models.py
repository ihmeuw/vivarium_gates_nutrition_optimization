...
MATERNAL_DISORDER_STATE_NAME = "maternal_disorders"
NO_MATERNAL_DISORDER_STATE_NAME = "no_maternal_disorders"
CHILDBIRTH_STATES = [MATERNAL_DISORDER_STATE_NAME, NO_MATERNAL_DISORDER_STATE_NAME]
PREGNANCY_MODEL_STATES = (
    NOT_PREGNANT_STATE_NAME,
    PREGNANT_STATE_NAME,
    MATERNAL_DISORDER_STATE_NAME,
    NO_MATERNAL_DISORDER_STATE_NAME,
    POSTPARTUM_STATE_NAME,
)
PREGNANCY_MODEL_TRANSITIONS = (
    TransitionString(f"{PREGNANT_STATE_NAME}_TO_{MATERNAL_DISORDER_STATE_NAME}"),
    TransitionString(f"{PREGNANT_STATE_NAME}_TO_{NO_MATERNAL_DISORDER_STATE_NAME}"),
    TransitionString(f"{MATERNAL_DISORDER_STATE_NAME}_TO_{POSTPARTUM_STATE_NAME}"),
    TransitionString(f"{NO_MATERNAL_DISORDER_STATE_NAME}_TO_{POSTPARTUM_STATE_NAME}"),
